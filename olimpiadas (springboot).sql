...
-- AUTO INCREMENTS
ALTER TABLE atleta MODIFY id_atleta INT AUTO_INCREMENT ;
ALTER TABLE region MODIFY id_region INT AUTO_INCREMENT ;
ALTER TABLE competidor_juego_olimpico MODIFY id_competidores INT AUTO_INCREMENT ;
